...
export interface UtilityValues {
	...
	srOnly: boolean;
	debug: boolean;
	colorPalette: "current" | "black" | "white" | "amber" | "amber.light" | "amber.dark" | "blue" | "blue.light" | "blue.dark" | "green" | "green.light" | "green.dark" | "orange" | "orange.light" | "orange.dark" | "pink" | "pink.light" | "pink.dark" | "red" | "red.light" | "red.dark" | "slate" | "slate.light" | "slate.dark" | "tomato" | "tomato.light" | "tomato.dark" | "gray" | "gray.light" | "gray.dark" | "neutral" | "neutral.light" | "neutral.dark" | "transparent" | "accent" | "accent.light" | "accent.dark" | "conicGradient" | "cardBackgroundGradient" | "backgroundGradientH" | "backgroundGradientV" | "background" | "text" | "border" | "scrim" | "selection" | "interactive" | "interactive.selected" | "interactive.emphasized" | "status" | "status.danger" | "status.success" | "status.warning" | "status.info" | "visibility" | "visibility.published.surface" | "visibility.published" | "visibility.published.content" | "visibility.published.border" | "visibility.draft.surface" | "visibility.draft" | "visibility.draft.content" | "visibility.draft.border" | "visibility.review.surface" | "visibility.review" | "visibility.review.content" | "visibility.review.border" | "visibility.unlisted.surface" | "visibility.unlisted" | "visibility.unlisted.content" | "visibility.unlisted.border" | "overflow-fade" | "scroll-fade-top";
