...
export interface TableRecipe {
  ...
  (props?: TableVariantProps): Pretty<Record<"root" | "body" | "cell" | "footer" | "head" | "header" | "row" | "caption" | "root" | "body" | "cell" | "footer" | "head" | "header" | "row" | "caption" | "root" | "body" | "cell" | "footer" | "head" | "header" | "row" | "caption", string>>
