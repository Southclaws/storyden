...
export const interDisplay = localFont({
  src: [
    ...
    { path: "static/InterDisplay-ThinItalic.woff2", weight: "100", style: "italic" },
    { path: "static/InterDisplay-ExtraLight.woff2", weight: "200" },
    { path: "static/InterDisplay-ExtraLightItalic.woff2", weight: "200", style: "italic" },
    { path: "static/InterDisplay-Light.woff2", weight: "300" },
    { path: "static/InterDisplay-LightItalic.woff2", weight: "300", style: "italic" },
    { path: "static/InterDisplay-Regular.woff2", weight: "400" },
    { path: "static/InterDisplay-Italic.woff2", weight: "400", style: "italic" },
    { path: "static/InterDisplay-Medium.woff2", weight: "500" },
    { path: "static/InterDisplay-MediumItalic.woff2", weight: "500", style: "italic" },
    { path: "static/InterDisplay-SemiBold.woff2", weight: "600" },
    { path: "static/InterDisplay-SemiBoldItalic.woff2", weight: "600", style: "italic" },
    { path: "static/InterDisplay-Bold.woff2", weight: "700" },
    { path: "static/InterDisplay-BoldItalic.woff2", weight: "700", style: "italic"},
    { path: "static/InterDisplay-ExtraBold.woff2", weight: "800" },
    { path: "static/InterDisplay-ExtraBoldItalic.woff2", weight: "800", style: "italic"},
    { path: "static/InterDisplay-Black.woff2", weight: "900" },
    { path: "static/InterDisplay-BlackItalic.woff2", weight: "900", style: "italic"},
  ],
  preload: true,
