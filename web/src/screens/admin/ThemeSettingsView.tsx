...
export function ThemeSettingsView(props: Props) {
  const { assets, editingEnabled } = props;
  const scriptCount = assets.filter(
    ({ mime_type }) => mime_type === "application/javascript",
  ).length;

  return (
    <LStack gap="6" width="full" alignItems="stretch">
      <PageHeader
        title="Custom theme"
      ...
      <section>
        <LStack gap="3" width="full" alignItems="stretch">
          <div>
          ...
          <CardBox>
            ...
            >
              ...
              {editingEnabled ? (
                ...
                <Button variant="solid" onClick={props.onEnableEditing}>
