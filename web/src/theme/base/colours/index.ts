...
export const colours = defineTokens.colors({
  ...
  accent: {
    light: {
      "1": { value: "var(--accent-colour-light-1)" },
      "2": { value: "var(--accent-colour-light-2)" },
      "3": { value: "var(--accent-colour-light-3)" },
      "4": { value: "var(--accent-colour-light-4)" },
      "5": { value: "var(--accent-colour-light-5)" },
      "6": { value: "var(--accent-colour-light-6)" },
      "7": { value: "var(--accent-colour-light-7)" },
      "8": { value: "var(--accent-colour-light-8)" },
      "9": { value: "var(--accent-colour-light-9)" },
      "10": { value: "var(--accent-colour-light-10)" },
      "11": { value: "var(--accent-colour-light-11)" },
      "12": { value: "var(--accent-colour-light-12)" },
    },
    dark: {
      "1": { value: "var(--accent-colour-dark-1)" },
      "2": { value: "var(--accent-colour-dark-2)" },
      "3": { value: "var(--accent-colour-dark-3)" },
      "4": { value: "var(--accent-colour-dark-4)" },
      "5": { value: "var(--accent-colour-dark-5)" },
      "6": { value: "var(--accent-colour-dark-6)" },
      "7": { value: "var(--accent-colour-dark-7)" },
      "8": { value: "var(--accent-colour-dark-8)" },
      "9": { value: "var(--accent-colour-dark-9)" },
      "10": { value: "var(--accent-colour-dark-10)" },
      "11": { value: "var(--accent-colour-dark-11)" },
      "12": { value: "var(--accent-colour-dark-12)" },
    },
  },
});
