...
import * as Checkbox from "./Checkbox.internal";
...
type FormCardGroupSelectProps<T extends FieldValues> = Omit<
  ControllerProps<T>,
  "render"
> & {
...
export function FormCardGroupSelect<T extends FieldValues>({
  items,
  ...props
}: FormCardGroupSelectProps<T>) {
  const defaultValue =
