...
export type FormColourPickerFieldProps<T extends FieldValues> = {
  control: Control<T>;
  name: Path<T>;
};

export function FormColourPickerField<T extends FieldValues>(
  props: FormColourPickerFieldProps<T>,
) {
  return (
    <Controller<T>
