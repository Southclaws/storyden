...
export const Arrow = withContext<
  HTMLDivElement,
  Assign<JsxStyleProps, Menu.ArrowProps>
>(Menu.Arrow, "arrow");

export const ArrowTip = withContext<
  HTMLDivElement,
  Assign<JsxStyleProps, Menu.ArrowTipProps>
...
export const Content = withContext<
  HTMLDivElement,
  Assign<JsxStyleProps, Menu.ContentProps>
...
export const Item = withContext<
  HTMLDivElement,
  Assign<JsxStyleProps, Menu.ItemProps>
>(Menu.Item, "item");
...
export const Trigger = withContext<
  HTMLButtonElement,
  Assign<JsxStyleProps, Menu.TriggerProps>
