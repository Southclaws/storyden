...
It's a little confusing because "WebAuthn" is the technical name, "Authn" is a shortening of "Authentication" because nobody wants to type long words any more (even though spicy autocomplete can do it for us now...?) and "Passkey" is the more "branded" and general term when displaying to users and customers. The terms technically aren't integerchangable but for the sake of the user's experience and simplicity, they can be considered the same thing.

I don't need to go into the details of what it actually is, you can learn about that on [this fantastic blog post by Neal Fennimore](https://css-tricks.com/passkeys-what-the-heck-and-why). There are also some more technical articles that go into the details such as [the W3 spec](https://www.w3.org/TR/webauthn-2/) and a [web.dev article](https://web.dev/articles/webauthn-discoverable-credentials).
...
All services I've enabled a Passkey on recently have treated them as a form of 2FA rather than your first login method. This isn't just because of support, but also difficulties with being locked out of your account. The spec does not define a way to recover accounts or synchronise keys. This is left up to vendors such as Apple, Microsoft and Google.
