const tokens = {
  ...
  "fonts.joie": {
    "value": "var(--font-joie)",
    "variable": "var(--fonts-joie)"
  },
  "fonts.worksans": {
    "value": "var(--font-worksans)",
    "variable": "var(--fonts-worksans)"
  },
  "fonts.hedvig": {
    "value": "var(--font-hedvig)",
    "variable": "var(--fonts-hedvig)"
  },
  "fonts.intelone": {
  ...
  "colors.Mono.ink": {
    "value": "#131b1a",
    "variable": "var(--colors--mono-ink)"
  },
  "colors.Mono.slush": {
    "value": "#f2f0ef",
    "variable": "var(--colors--mono-slush)"
  },
  "colors.Primary.forest": {
    "value": "#307343",
    "variable": "var(--colors--primary-forest)"
  },
  "colors.Primary.saddle": {
    "value": "#854627",
    "variable": "var(--colors--primary-saddle)"
  },
  "colors.Primary.campfire": {
    "value": "#d68e4d",
    "variable": "var(--colors--primary-campfire)"
  },
  "colors.Primary.moonlit": {
    "value": "#104059",
    "variable": "var(--colors--primary-moonlit)"
  },
  "colors.Shades.iron": {
    "value": "#303e47",
    "variable": "var(--colors--shades-iron)"
  },
  "colors.Shades.slate": {
    "value": "#212429",
    "variable": "var(--colors--shades-slate)"
  },
  "colors.Shades.newspaper": {
    "value": "#d8dbcd",
    "variable": "var(--colors--shades-newspaper)"
  },
  "colors.Shades.stone": {
    "value": "#8cada4",
    "variable": "var(--colors--shades-stone)"
  },
  "breakpoints.sm": {
    "value": "640px",
  ...
  "colors.colorPalette.ink": {
    "value": "var(--colors-color-palette-ink)",
    "variable": "var(--colors-color-palette-ink)"
  },
  "colors.colorPalette.slush": {
    "value": "var(--colors-color-palette-slush)",
    "variable": "var(--colors-color-palette-slush)"
  },
  "colors.colorPalette.forest": {
    "value": "var(--colors-color-palette-forest)",
    "variable": "var(--colors-color-palette-forest)"
  },
  "colors.colorPalette.saddle": {
    "value": "var(--colors-color-palette-saddle)",
    "variable": "var(--colors-color-palette-saddle)"
  },
  "colors.colorPalette.campfire": {
    "value": "var(--colors-color-palette-campfire)",
    "variable": "var(--colors-color-palette-campfire)"
  },
  "colors.colorPalette.moonlit": {
    "value": "var(--colors-color-palette-moonlit)",
    "variable": "var(--colors-color-palette-moonlit)"
  },
  "colors.colorPalette.iron": {
    "value": "var(--colors-color-palette-iron)",
    "variable": "var(--colors-color-palette-iron)"
  },
  "colors.colorPalette.slate": {
    "value": "var(--colors-color-palette-slate)",
    "variable": "var(--colors-color-palette-slate)"
  },
  "colors.colorPalette.newspaper": {
    "value": "var(--colors-color-palette-newspaper)",
    "variable": "var(--colors-color-palette-newspaper)"
  },
