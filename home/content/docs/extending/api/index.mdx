...
<Card href="/docs/extending/api/events" title="Events">
  All events emitted by Storyden.
</Card>

<Card href="/docs/extending/api/host-to-plugin" title="Host to Plugin">
  RPCs Storyden sends to plugins.
</Card>

<Card href="/docs/extending/api/plugin-to-host" title="Plugin to Host">
  RPCs plugins can send to Storyden.
</Card>
