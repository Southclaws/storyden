...
The HTTP API handles instance-side management and can not be interacted with via an [Access Key](/docs/reference/access-keys), only via a web based session:
