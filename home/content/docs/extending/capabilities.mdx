...
For the most part. Supervised plugins _do_ run in the same environment as Storyden itself. Technically you can do it, but it's not advised _especially_ if you're distributing a plugin for other people.
