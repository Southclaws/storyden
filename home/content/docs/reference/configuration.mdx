...
<table>
  <tr>
    <td>type</td>
    <td>url (e.g. http://example.com)</td>
  </tr>
  <tr>
    <td>default</td>
    <td>(empty string)</td>
...
<table>
  ...
  <tr>
    <td>default</td>
    <td>`sqlite://data/data.db?_pragma=foreign_keys(1)`</td>
  </tr>
</table>
...
<table>
  <tr>
    <td>type</td>
    <td>`integer` (number without decimal point)</td>
  </tr>
  <tr>
    <td>default</td>
    <td>`5000`</td>
...
<table>
  <tr>
    <td>type</td>
    <td>boolean (`true` or `false`, case sensitive)</td>
  </tr>
  <tr>
    <td>default</td>
    <td>none</td>
