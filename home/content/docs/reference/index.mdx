...
<Cards>
  <Card href="/docs/reference/configuration" title="Configuration">
  ...
  <Card href="/docs/reference/email" title="Email">
    How Storyden uses email, running with no email at all, supported providers
    and setup guides.
  </Card>
  <Card href="/docs/reference/settings" title="Settings">
