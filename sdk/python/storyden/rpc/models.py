...
class RPCRequestRobotModelProviderEmbedTextParams(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
class RPCRequestRobotModelProviderStructuredPromptParams(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
class RPCRequestRobotModelProviderStructuredPrompt(JsonRpcRequest):
    method: Literal["robot_model_provider_structured_prompt"]
...
class RPCRequestRobotModelProviderEmbedText(JsonRpcRequest):
    method: Literal["robot_model_provider_embed_text"]
...
HostToPluginRequest = Annotated[
    Union[RPCRequestConfigure, RPCRequestEvent, RPCRequestPing, RPCRequestRobotModelProviderListModels, RPCRequestRobotModelProviderGenerate, RPCRequestRobotModelProviderStructuredPrompt, RPCRequestRobotModelProviderEmbedText, RPCRequestRobotToolCall],
...
class RPCResponseRobotModelProviderStructuredPrompt(BaseModel):
    model_config = ConfigDict(extra="forbid")
    method: Literal["robot_model_provider_structured_prompt"]
...
class RPCResponseRobotModelProviderEmbedText(BaseModel):
    model_config = ConfigDict(extra="forbid")
    method: Literal["robot_model_provider_embed_text"]
...
HostToPluginResponseUnion = Annotated[
    Union[RPCResponseConfigure, RPCResponseEvent, RPCResponsePing, RPCResponseRobotModelProviderListModels, RPCResponseRobotModelProviderGenerate, RPCResponseRobotModelProviderStructuredPrompt, RPCResponseRobotModelProviderEmbedText, RPCResponseRobotToolCall],
    Field(discriminator="method"),
]
