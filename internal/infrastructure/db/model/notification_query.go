...
func (ngb *NotificationGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(ngb.fields) > 1 {
		return nil, errors.New("model: NotificationGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := ngb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ngb *NotificationGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{notification.Label}
	default:
		err = fmt.Errorf("model: NotificationGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ngb *NotificationGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(ngb.fields) > 1 {
		return nil, errors.New("model: NotificationGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := ngb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ngb *NotificationGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{notification.Label}
	default:
		err = fmt.Errorf("model: NotificationGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ngb *NotificationGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(ngb.fields) > 1 {
		return nil, errors.New("model: NotificationGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := ngb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ngb *NotificationGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{notification.Label}
	default:
		err = fmt.Errorf("model: NotificationGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ngb *NotificationGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(ngb.fields) > 1 {
		return nil, errors.New("model: NotificationGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := ngb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ngb *NotificationGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{notification.Label}
	default:
		err = fmt.Errorf("model: NotificationGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ns *NotificationSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ns.fields) > 1 {
		return nil, errors.New("model: NotificationSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ns.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ns *NotificationSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{notification.Label}
	default:
		err = fmt.Errorf("model: NotificationSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ns *NotificationSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ns.fields) > 1 {
		return nil, errors.New("model: NotificationSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ns.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ns *NotificationSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{notification.Label}
	default:
		err = fmt.Errorf("model: NotificationSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ns *NotificationSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ns.fields) > 1 {
		return nil, errors.New("model: NotificationSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ns.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ns *NotificationSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{notification.Label}
	default:
		err = fmt.Errorf("model: NotificationSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ns *NotificationSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ns.fields) > 1 {
		return nil, errors.New("model: NotificationSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ns.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ns *NotificationSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{notification.Label}
	default:
		err = fmt.Errorf("model: NotificationSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
