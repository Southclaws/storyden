...
const (
	PageTypeCluster     PageType = "cluster"
	PageTypeClusterList PageType = "cluster_list"
	PageTypeContentFeed PageType = "content_feed"
...
// ClusterSlugList defines model for ClusterSlugList.
type ClusterSlugList = []Slug
...
// PageAdditional defines model for PageAdditional.
type PageAdditional struct {
	PostCount int `json:"postCount"`
}

// PageClusterListMutableProps defines model for PageClusterListMutableProps.
type PageClusterListMutableProps struct {
	Clusters *ClusterSlugList `json:"clusters,omitempty"`
}

// PageClusterListProps defines model for PageClusterListProps.
type PageClusterListProps struct {
	Clusters *ClusterList `json:"clusters,omitempty"`
}

// PageClusterMutableProps defines model for PageClusterMutableProps.
type PageClusterMutableProps struct {
	Clusters *ClusterSlugList `json:"clusters,omitempty"`
}

// PageClusterProps defines model for PageClusterProps.
type PageClusterProps struct {
	// Cluster A cluster is a group of items and other clusters. It serves as an
...
// PageInitialProps Defines the specific mutable properties depending on the type. The type
// specified here may change the type of a page and may result in config
// related to the original type being lost. For example, if you switch from
// a static content page to a feed page, the original content will be lost.
type PageInitialProps = PageTypeSpecificMutableProps

// PageList defines model for PageList.
type PageList struct {
	Categories []Page `json:"categories"`
}

// PageMutableProps Defines the specific mutable properties depending on the type. The type
// specified here may change the type of a page and may result in config
// related to the original type being lost. For example, if you switch from
// a static content page to a feed page, the original content will be lost.
type PageMutableProps = PageTypeSpecificMutableProps

// PageName A Page's user-facing name.
type PageName = string

// PageSlug A Page's URL-safe slug.
type PageSlug = string

// PageSlugList A list of Page names.
type PageSlugList = []PageSlug

// PageType defines model for PageType.
type PageType string

// PageTypeContentFeedMutableProps defines model for PageTypeContentFeedMutableProps.
type PageTypeContentFeedMutableProps struct {
	// Category A unique identifier for this resource.
	Category *Identifier `json:"category,omitempty"`
}

// PageTypeContentFeedProps defines model for PageTypeContentFeedProps.
type PageTypeContentFeedProps struct {
	Feed *ThreadList `json:"feed,omitempty"`
}

// PageTypeSpecificMutableProps Defines the specific mutable properties depending on the type. The type
// specified here may change the type of a page and may result in config
// related to the original type being lost. For example, if you switch from
// a static content page to a feed page, the original content will be lost.
type PageTypeSpecificMutableProps struct {
	Type  PageType `json:"type"`
	union json.RawMessage
}

// PageTypeStaticMutableProps defines model for PageTypeStaticMutableProps.
type PageTypeStaticMutableProps struct {
	// Content The body text of a post within a thread. The type is either a string or
	// an object, depending on what was used during creation. Strings can be
	// used for basic plain text or markdown content and objects are used for
	// more complex types such as Slate.js editor documents.
...
// PageTypeStaticProps defines model for PageTypeStaticProps.
type PageTypeStaticProps struct {
	// Content The body text of a post within a thread. The type is either a string or
	// an object, depending on what was used during creation. Strings can be
	// used for basic plain text or markdown content and objects are used for
	// more complex types such as Slate.js editor documents.
...
// PageSlugParam defines model for PageSlugParam.
type PageSlugParam = string
...
// PageCreateOK defines model for PageCreateOK.
type PageCreateOK = Page

// PageListOK defines model for PageListOK.
type PageListOK = PageList

// PageUpdateOK defines model for PageUpdateOK.
type PageUpdateOK = Page
...
type PageCreate = PageInitialProps

// PageUpdate defines model for PageUpdate.
type PageUpdate = PageMutableProps

// PageUpdateOrder A list of Page names.
type PageUpdateOrder = PageSlugList
...
// PageUpdateOrderJSONRequestBody defines body for PageUpdateOrder for application/json ContentType.
type PageUpdateOrderJSONRequestBody = PageSlugList

// PageCreateJSONRequestBody defines body for PageCreate for application/json ContentType.
type PageCreateJSONRequestBody = PageInitialProps

// PageUpdateJSONRequestBody defines body for PageUpdate for application/json ContentType.
type PageUpdateJSONRequestBody = PageMutableProps
...
// AsPageTypeStaticMutableProps returns the union data inside the PageTypeSpecificMutableProps as a PageTypeStaticMutableProps
func (t PageTypeSpecificMutableProps) AsPageTypeStaticMutableProps() (PageTypeStaticMutableProps, error) {
	var body PageTypeStaticMutableProps
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromPageTypeStaticMutableProps overwrites any union data inside the PageTypeSpecificMutableProps as the provided PageTypeStaticMutableProps
func (t *PageTypeSpecificMutableProps) FromPageTypeStaticMutableProps(v PageTypeStaticMutableProps) error {
	t.Type = "static"
...
// MergePageTypeStaticMutableProps performs a merge with any union data inside the PageTypeSpecificMutableProps, using the provided PageTypeStaticMutableProps
func (t *PageTypeSpecificMutableProps) MergePageTypeStaticMutableProps(v PageTypeStaticMutableProps) error {
	t.Type = "static"
...
// AsPageTypeContentFeedMutableProps returns the union data inside the PageTypeSpecificMutableProps as a PageTypeContentFeedMutableProps
func (t PageTypeSpecificMutableProps) AsPageTypeContentFeedMutableProps() (PageTypeContentFeedMutableProps, error) {
	var body PageTypeContentFeedMutableProps
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromPageTypeContentFeedMutableProps overwrites any union data inside the PageTypeSpecificMutableProps as the provided PageTypeContentFeedMutableProps
func (t *PageTypeSpecificMutableProps) FromPageTypeContentFeedMutableProps(v PageTypeContentFeedMutableProps) error {
	t.Type = "content_feed"
...
// MergePageTypeContentFeedMutableProps performs a merge with any union data inside the PageTypeSpecificMutableProps, using the provided PageTypeContentFeedMutableProps
func (t *PageTypeSpecificMutableProps) MergePageTypeContentFeedMutableProps(v PageTypeContentFeedMutableProps) error {
	t.Type = "content_feed"
...
// AsPageClusterListMutableProps returns the union data inside the PageTypeSpecificMutableProps as a PageClusterListMutableProps
func (t PageTypeSpecificMutableProps) AsPageClusterListMutableProps() (PageClusterListMutableProps, error) {
	var body PageClusterListMutableProps
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromPageClusterListMutableProps overwrites any union data inside the PageTypeSpecificMutableProps as the provided PageClusterListMutableProps
func (t *PageTypeSpecificMutableProps) FromPageClusterListMutableProps(v PageClusterListMutableProps) error {
	t.Type = "cluster_list"
...
// MergePageClusterListMutableProps performs a merge with any union data inside the PageTypeSpecificMutableProps, using the provided PageClusterListMutableProps
func (t *PageTypeSpecificMutableProps) MergePageClusterListMutableProps(v PageClusterListMutableProps) error {
	t.Type = "cluster_list"
...
// AsPageClusterMutableProps returns the union data inside the PageTypeSpecificMutableProps as a PageClusterMutableProps
func (t PageTypeSpecificMutableProps) AsPageClusterMutableProps() (PageClusterMutableProps, error) {
	var body PageClusterMutableProps
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromPageClusterMutableProps overwrites any union data inside the PageTypeSpecificMutableProps as the provided PageClusterMutableProps
func (t *PageTypeSpecificMutableProps) FromPageClusterMutableProps(v PageClusterMutableProps) error {
	t.Type = "cluster"
...
// MergePageClusterMutableProps performs a merge with any union data inside the PageTypeSpecificMutableProps, using the provided PageClusterMutableProps
func (t *PageTypeSpecificMutableProps) MergePageClusterMutableProps(v PageClusterMutableProps) error {
	t.Type = "cluster"
...
func (t PageTypeSpecificMutableProps) Discriminator() (string, error) {
...
func (t PageTypeSpecificMutableProps) ValueByDiscriminator() (interface{}, error) {
	...
	case "cluster":
		return t.AsPageClusterMutableProps()
	case "cluster_list":
		return t.AsPageClusterListMutableProps()
	case "content_feed":
		return t.AsPageTypeContentFeedMutableProps()
	case "static":
		return t.AsPageTypeStaticMutableProps()
	default:
		return nil, errors.New("unknown discriminator value: " + discriminator)
	}
}

func (t PageTypeSpecificMutableProps) MarshalJSON() ([]byte, error) {
...
func (t *PageTypeSpecificMutableProps) UnmarshalJSON(b []byte) error {
...
type ClientInterface interface {
	...
	// PageList request
	PageList(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error)

	// PageUpdateOrderWithBody request with any body
	PageUpdateOrderWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	PageUpdateOrder(ctx context.Context, body PageUpdateOrderJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// PageCreateWithBody request with any body
	PageCreateWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	PageCreate(ctx context.Context, body PageCreateJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)

	// PageUpdateWithBody request with any body
	PageUpdateWithBody(ctx context.Context, pageSlug PageSlugParam, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	PageUpdate(ctx context.Context, pageSlug PageSlugParam, body PageUpdateJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) PageList(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPageListRequest(c.Server)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) PageUpdateOrderWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPageUpdateOrderRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) PageUpdateOrder(ctx context.Context, body PageUpdateOrderJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPageUpdateOrderRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) PageCreateWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPageCreateRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) PageCreate(ctx context.Context, body PageCreateJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPageCreateRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) PageUpdateWithBody(ctx context.Context, pageSlug PageSlugParam, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPageUpdateRequestWithBody(c.Server, pageSlug, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) PageUpdate(ctx context.Context, pageSlug PageSlugParam, body PageUpdateJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPageUpdateRequest(c.Server, pageSlug, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewPageListRequest generates requests for PageList
func NewPageListRequest(server string) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/v1/pages")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewPageUpdateOrderRequest calls the generic PageUpdateOrder builder with application/json body
func NewPageUpdateOrderRequest(server string, body PageUpdateOrderJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewPageUpdateOrderRequestWithBody(server, "application/json", bodyReader)
}

// NewPageUpdateOrderRequestWithBody generates requests for PageUpdateOrder with any type of body
func NewPageUpdateOrderRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
// NewPageCreateRequest calls the generic PageCreate builder with application/json body
func NewPageCreateRequest(server string, body PageCreateJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewPageCreateRequestWithBody(server, "application/json", bodyReader)
}

// NewPageCreateRequestWithBody generates requests for PageCreate with any type of body
func NewPageCreateRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
// NewPageUpdateRequest calls the generic PageUpdate builder with application/json body
func NewPageUpdateRequest(server string, pageSlug PageSlugParam, body PageUpdateJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewPageUpdateRequestWithBody(server, pageSlug, "application/json", bodyReader)
}

// NewPageUpdateRequestWithBody generates requests for PageUpdate with any type of body
func NewPageUpdateRequestWithBody(server string, pageSlug PageSlugParam, contentType string, body io.Reader) (*http.Request, error) {
	var err error

	var pathParam0 string

	pathParam0, err = runtime.StyleParamWithLocation("simple", false, "page_slug", runtime.ParamLocationPath, pageSlug)
	if err != nil {
		return nil, err
	}
	...
	operationPath := fmt.Sprintf("/v1/pages/%s", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// PageListWithResponse request
	PageListWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*PageListResponse, error)

	// PageUpdateOrderWithBodyWithResponse request with any body
	PageUpdateOrderWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PageUpdateOrderResponse, error)

	PageUpdateOrderWithResponse(ctx context.Context, body PageUpdateOrderJSONRequestBody, reqEditors ...RequestEditorFn) (*PageUpdateOrderResponse, error)

	// PageCreateWithBodyWithResponse request with any body
	PageCreateWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PageCreateResponse, error)

	PageCreateWithResponse(ctx context.Context, body PageCreateJSONRequestBody, reqEditors ...RequestEditorFn) (*PageCreateResponse, error)

	// PageUpdateWithBodyWithResponse request with any body
	PageUpdateWithBodyWithResponse(ctx context.Context, pageSlug PageSlugParam, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PageUpdateResponse, error)

	PageUpdateWithResponse(ctx context.Context, pageSlug PageSlugParam, body PageUpdateJSONRequestBody, reqEditors ...RequestEditorFn) (*PageUpdateResponse, error)
...
// Status returns HTTPResponse.Status
func (r PageListResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r PageListResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type PageUpdateOrderResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *PageListOK
	JSONDefault  *InternalServerError
...
// Status returns HTTPResponse.Status
func (r PageUpdateOrderResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r PageUpdateOrderResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type PageCreateResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *PageCreateOK
	JSONDefault  *InternalServerError
}

// Status returns HTTPResponse.Status
func (r PageCreateResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r PageCreateResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type PageUpdateResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *PageUpdateOK
	JSONDefault  *InternalServerError
}

// Status returns HTTPResponse.Status
func (r PageUpdateResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r PageUpdateResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// PageListWithResponse request returning *PageListResponse
func (c *ClientWithResponses) PageListWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*PageListResponse, error) {
	rsp, err := c.PageList(ctx, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePageListResponse(rsp)
}

// PageUpdateOrderWithBodyWithResponse request with arbitrary body returning *PageUpdateOrderResponse
func (c *ClientWithResponses) PageUpdateOrderWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PageUpdateOrderResponse, error) {
	rsp, err := c.PageUpdateOrderWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePageUpdateOrderResponse(rsp)
}

func (c *ClientWithResponses) PageUpdateOrderWithResponse(ctx context.Context, body PageUpdateOrderJSONRequestBody, reqEditors ...RequestEditorFn) (*PageUpdateOrderResponse, error) {
	rsp, err := c.PageUpdateOrder(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePageUpdateOrderResponse(rsp)
...
// PageCreateWithBodyWithResponse request with arbitrary body returning *PageCreateResponse
func (c *ClientWithResponses) PageCreateWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PageCreateResponse, error) {
	rsp, err := c.PageCreateWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePageCreateResponse(rsp)
}

func (c *ClientWithResponses) PageCreateWithResponse(ctx context.Context, body PageCreateJSONRequestBody, reqEditors ...RequestEditorFn) (*PageCreateResponse, error) {
	rsp, err := c.PageCreate(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePageCreateResponse(rsp)
...
// PageUpdateWithBodyWithResponse request with arbitrary body returning *PageUpdateResponse
func (c *ClientWithResponses) PageUpdateWithBodyWithResponse(ctx context.Context, pageSlug PageSlugParam, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PageUpdateResponse, error) {
	rsp, err := c.PageUpdateWithBody(ctx, pageSlug, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePageUpdateResponse(rsp)
}

func (c *ClientWithResponses) PageUpdateWithResponse(ctx context.Context, pageSlug PageSlugParam, body PageUpdateJSONRequestBody, reqEditors ...RequestEditorFn) (*PageUpdateResponse, error) {
	rsp, err := c.PageUpdate(ctx, pageSlug, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePageUpdateResponse(rsp)
...
// ParsePageListResponse parses an HTTP response from a PageListWithResponse call
func ParsePageListResponse(rsp *http.Response) (*PageListResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
...
// ParsePageUpdateOrderResponse parses an HTTP response from a PageUpdateOrderWithResponse call
func ParsePageUpdateOrderResponse(rsp *http.Response) (*PageUpdateOrderResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &PageUpdateOrderResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParsePageCreateResponse parses an HTTP response from a PageCreateWithResponse call
func ParsePageCreateResponse(rsp *http.Response) (*PageCreateResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
...
// ParsePageUpdateResponse parses an HTTP response from a PageUpdateWithResponse call
func ParsePageUpdateResponse(rsp *http.Response) (*PageUpdateResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
...
type ServerInterface interface {
	...
	// (PATCH /v1/pages)
	PageUpdateOrder(ctx echo.Context) error

	// (POST /v1/pages)
	PageCreate(ctx echo.Context) error

	// (PATCH /v1/pages/{page_slug})
	PageUpdate(ctx echo.Context, pageSlug PageSlugParam) error
...
// PageUpdateOrder converts echo context to params.
func (w *ServerInterfaceWrapper) PageUpdateOrder(ctx echo.Context) error {
	var err error

	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PageUpdateOrder(ctx)
	return err
}
...
func (w *ServerInterfaceWrapper) PageUpdate(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "page_slug" -------------
	var pageSlug PageSlugParam

	err = runtime.BindStyledParameterWithLocation("simple", false, "page_slug", runtime.ParamLocationPath, ctx.Param("page_slug"), &pageSlug)
	if err != nil {
		return echo.NewHTTPError(http.StatusBadRequest, fmt.Sprintf("Invalid format for parameter page_slug: %s", err))
	}

	ctx.Set(BrowserScopes, []string{})

	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.PageUpdate(ctx, pageSlug)
	return err
}
...
func RegisterHandlersWithBaseURL(router EchoRouter, si ServerInterface, baseURL string) {
	...
	router.GET(baseURL+"/v1/pages", wrapper.PageList)
	router.PATCH(baseURL+"/v1/pages", wrapper.PageUpdateOrder)
	router.POST(baseURL+"/v1/pages", wrapper.PageCreate)
	router.PATCH(baseURL+"/v1/pages/:page_slug", wrapper.PageUpdate)
...
type PageCreateOKJSONResponse Page

type PageListOKJSONResponse PageList

type PageUpdateOKJSONResponse Page
...
type PageListRequestObject struct {
}

type PageListResponseObject interface {
	VisitPageListResponse(w http.ResponseWriter) error
}

type PageList200JSONResponse struct{ PageListOKJSONResponse }

func (response PageList200JSONResponse) VisitPageListResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(200)
...
type PageListdefaultJSONResponse struct {
	Body       APIError
	StatusCode int
}

func (response PageListdefaultJSONResponse) VisitPageListResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(response.StatusCode)
...
type PageUpdateOrderRequestObject struct {
	Body *PageUpdateOrderJSONRequestBody
}

type PageUpdateOrderResponseObject interface {
	VisitPageUpdateOrderResponse(w http.ResponseWriter) error
}

type PageUpdateOrder200JSONResponse struct{ PageListOKJSONResponse }

func (response PageUpdateOrder200JSONResponse) VisitPageUpdateOrderResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(200)
...
type PageUpdateOrderdefaultJSONResponse struct {
	Body       APIError
	StatusCode int
}

func (response PageUpdateOrderdefaultJSONResponse) VisitPageUpdateOrderResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(response.StatusCode)
...
type PageCreateRequestObject struct {
	Body *PageCreateJSONRequestBody
}

type PageCreateResponseObject interface {
	VisitPageCreateResponse(w http.ResponseWriter) error
}

type PageCreate200JSONResponse struct{ PageCreateOKJSONResponse }

func (response PageCreate200JSONResponse) VisitPageCreateResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(200)
...
type PageCreate400Response = BadRequestResponse

func (response PageCreate400Response) VisitPageCreateResponse(w http.ResponseWriter) error {
	w.WriteHeader(400)
	return nil
}

type PageCreate401Response = UnauthorisedResponse

func (response PageCreate401Response) VisitPageCreateResponse(w http.ResponseWriter) error {
	w.WriteHeader(401)
	return nil
}

type PageCreatedefaultJSONResponse struct {
	Body       APIError
	StatusCode int
}

func (response PageCreatedefaultJSONResponse) VisitPageCreateResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(response.StatusCode)
...
type PageUpdateRequestObject struct {
	PageSlug PageSlugParam `json:"page_slug"`
	Body     *PageUpdateJSONRequestBody
}

type PageUpdateResponseObject interface {
	VisitPageUpdateResponse(w http.ResponseWriter) error
}

type PageUpdate200JSONResponse struct{ PageUpdateOKJSONResponse }

func (response PageUpdate200JSONResponse) VisitPageUpdateResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(200)
...
type PageUpdate400Response = BadRequestResponse

func (response PageUpdate400Response) VisitPageUpdateResponse(w http.ResponseWriter) error {
	w.WriteHeader(400)
	return nil
}

type PageUpdate401Response = UnauthorisedResponse

func (response PageUpdate401Response) VisitPageUpdateResponse(w http.ResponseWriter) error {
	w.WriteHeader(401)
	return nil
}

type PageUpdatedefaultJSONResponse struct {
	Body       APIError
	StatusCode int
}

func (response PageUpdatedefaultJSONResponse) VisitPageUpdateResponse(w http.ResponseWriter) error {
	w.Header().Set("Content-Type", "application/json")
	w.WriteHeader(response.StatusCode)
...
type StrictServerInterface interface {
	...
	// (GET /v1/pages)
	PageList(ctx context.Context, request PageListRequestObject) (PageListResponseObject, error)

	// (PATCH /v1/pages)
	PageUpdateOrder(ctx context.Context, request PageUpdateOrderRequestObject) (PageUpdateOrderResponseObject, error)

	// (POST /v1/pages)
	PageCreate(ctx context.Context, request PageCreateRequestObject) (PageCreateResponseObject, error)

	// (PATCH /v1/pages/{page_slug})
	PageUpdate(ctx context.Context, request PageUpdateRequestObject) (PageUpdateResponseObject, error)
...
// PageList operation middleware
func (sh *strictHandler) PageList(ctx echo.Context) error {
	var request PageListRequestObject

	handler := func(ctx echo.Context, request interface{}) (interface{}, error) {
		return sh.ssi.PageList(ctx.Request().Context(), request.(PageListRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "PageList")
	}
	...
	if err != nil {
		return err
	} else if validResponse, ok := response.(PageListResponseObject); ok {
		return validResponse.VisitPageListResponse(ctx.Response())
	} else if response != nil {
		return fmt.Errorf("unexpected response type: %T", response)
	}
	return nil
...
// PageUpdateOrder operation middleware
func (sh *strictHandler) PageUpdateOrder(ctx echo.Context) error {
	var request PageUpdateOrderRequestObject

	var body PageUpdateOrderJSONRequestBody
	if err := ctx.Bind(&body); err != nil {
		return err
	}
	request.Body = &body
	...
	handler := func(ctx echo.Context, request interface{}) (interface{}, error) {
		return sh.ssi.PageUpdateOrder(ctx.Request().Context(), request.(PageUpdateOrderRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "PageUpdateOrder")
	}
	...
	if err != nil {
		return err
	} else if validResponse, ok := response.(PageUpdateOrderResponseObject); ok {
		return validResponse.VisitPageUpdateOrderResponse(ctx.Response())
	} else if response != nil {
		return fmt.Errorf("unexpected response type: %T", response)
	}
	return nil
...
// PageCreate operation middleware
func (sh *strictHandler) PageCreate(ctx echo.Context) error {
	var request PageCreateRequestObject

	var body PageCreateJSONRequestBody
	if err := ctx.Bind(&body); err != nil {
		return err
	}
	request.Body = &body
	...
	handler := func(ctx echo.Context, request interface{}) (interface{}, error) {
		return sh.ssi.PageCreate(ctx.Request().Context(), request.(PageCreateRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "PageCreate")
	}
	...
	if err != nil {
		return err
	} else if validResponse, ok := response.(PageCreateResponseObject); ok {
		return validResponse.VisitPageCreateResponse(ctx.Response())
	} else if response != nil {
		return fmt.Errorf("unexpected response type: %T", response)
	}
	return nil
...
// PageUpdate operation middleware
func (sh *strictHandler) PageUpdate(ctx echo.Context, pageSlug PageSlugParam) error {
	var request PageUpdateRequestObject

	request.PageSlug = pageSlug

	var body PageUpdateJSONRequestBody
	if err := ctx.Bind(&body); err != nil {
		return err
	}
	request.Body = &body
	...
	handler := func(ctx echo.Context, request interface{}) (interface{}, error) {
		return sh.ssi.PageUpdate(ctx.Request().Context(), request.(PageUpdateRequestObject))
	}
	for _, middleware := range sh.middlewares {
		handler = middleware(handler, "PageUpdate")
	}
	...
	if err != nil {
		return err
	} else if validResponse, ok := response.(PageUpdateResponseObject); ok {
		return validResponse.VisitPageUpdateResponse(ctx.Response())
	} else if response != nil {
		return fmt.Errorf("unexpected response type: %T", response)
	}
	return nil
...
var swaggerSpec = []string{
	...
	"H4sIAAAAAAAC/+y9a3PcNpYw/Ffw9r5V2d1qSbFnM7vlqqfqUeyZjDYXey1750PaJaNJdDciEmAAUO2O",
	"S//9KRxcCJLgpdmUL5r5klhN4AA4Bzg4d3xcJDwvOCNMycWzj4sCC5wTRQT8dZkkvGTqb5ilGXmlP+lf",
	"UyITQQtFOVs8c23QDhqdL5YL8gHnRUYWzxaSl2qXZHgvF8sF1a0LrHaL5YLhXH/Hpu+N6btYLgT5vaSC",
	"pItnSpRkuZDJjuRYD/r/C7JZPFv8y0U13wvzVV7Uprm4v18uLqUk6pUeqz1f/QldvTiPT4mmvdNQhwIW",
	"pgRlWxjqOVZky8Xh6kUHgt4y+ntJUGLbdQ/tWtwMzKEPFVcpYYpuKBFmclkpFRHXWbl9vqNZOjBF0xrp",
	"5l1zNE1uZFZubxIN8gGmOussZ5sfzzKS6KkMUtq37KG1bzMntTlThKmfCNvGdv73PD2gxLRBGTRClKH1",
	"QRHpp7kjOCWimqiFeWaBjjgbrMzXdkJXCWfX9A/Snov+giT9w4xccYzvnjz98N2Tpx1nM+HsRnfqnQZh",
	"Zb549msA6k9PP/xJ///Jf3374cl/fav/9fTbD0+ewr/+/J8fnvz5P/W/vnv64cl3TxfvlpFTfqVIPrw1",
	"qSJ5377U32fdlC8vS7V7Jfgd1URrTevNjiDqe6ANFwgzBJ2eosJ2Q7JMdghLtFqoPVWKiNWiThT7c3xN",
	"HJdqd+OAHck8X+EtGUZrgbcEvX39E5LdqNVthlEbmQGXauhAF1z23Bj664yH+Jpgkez+pyTi0J6Q+Yh+",
	"11+RWYWfFfxYTev3Rf/C3+wEwenPWNx2LN40QKXBAWYpKojIsZ58sKk6kKKg802Oxe1kxFQzXNzrGWso",
	"RKrveUpJKJ5cE3V5hxWGA2D5m/4nLoqMJlgv54IniqgzqQQxS61msOEix2rxbLGmDAMCm7gCgcIM9bZI",
	"sSI94/wmNe4+Hie4/FwqvM7IK8EL6cZLc8quiVKUbeXco4awY2NrCeltkXGcPhRGl82DBqMhjDZUy5B6",
