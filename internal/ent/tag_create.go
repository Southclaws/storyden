...
func (_c *TagCreate) SetID(v xid.ID) *TagCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *TagCreate) SetNillableID(v *xid.ID) *TagCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *TagCreate) AddPostIDs(ids ...xid.ID) *TagCreate {
...
func (_c *TagCreate) AddNodeIDs(ids ...xid.ID) *TagCreate {
	_c.mutation.AddNodeIDs(ids...)
	return _c
}

// AddNodes adds the "nodes" edges to the Node entity.
func (_c *TagCreate) AddNodes(v ...*Node) *TagCreate {
	ids := make([]xid.ID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_c *TagCreate) AddAccountIDs(ids ...xid.ID) *TagCreate {
	_c.mutation.AddAccountIDs(ids...)
	return _c
}

// AddAccounts adds the "accounts" edges to the Account entity.
func (_c *TagCreate) AddAccounts(v ...*Account) *TagCreate {
	ids := make([]xid.ID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
