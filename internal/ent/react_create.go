...
func (_c *ReactCreate) SetCreatedAt(v time.Time) *ReactCreate {
	_c.mutation.SetCreatedAt(v)
	return _c
}

// SetNillableCreatedAt sets the "created_at" field if the given value is not nil.
func (_c *ReactCreate) SetNillableCreatedAt(v *time.Time) *ReactCreate {
	if v != nil {
		_c.SetCreatedAt(*v)
	}
	return _c
...
func (_c *ReactCreate) SetAccountID(v xid.ID) *ReactCreate {
	_c.mutation.SetAccountID(v)
	return _c
}

// SetPostID sets the "post_id" field.
func (_c *ReactCreate) SetPostID(v xid.ID) *ReactCreate {
	_c.mutation.SetPostID(v)
	return _c
}

// SetEmoji sets the "emoji" field.
func (_c *ReactCreate) SetEmoji(v string) *ReactCreate {
	_c.mutation.SetEmoji(v)
	return _c
}

// SetID sets the "id" field.
func (_c *ReactCreate) SetID(v xid.ID) *ReactCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetNillableID sets the "id" field if the given value is not nil.
func (_c *ReactCreate) SetNillableID(v *xid.ID) *ReactCreate {
	if v != nil {
		_c.SetID(*v)
	}
	return _c
...
func (_c *ReactCreate) SetAccount(v *Account) *ReactCreate {
	return _c.SetAccountID(v.ID)
}

// SetPost sets the "Post" edge to the Post entity.
func (_c *ReactCreate) SetPost(v *Post) *ReactCreate {
	return _c.SetPostID(v.ID)
}

// Mutation returns the ReactMutation object of the builder.
func (_c *ReactCreate) Mutation() *ReactMutation {
	return _c.mutation
}

// Save creates the React in the database.
func (_c *ReactCreate) Save(ctx context.Context) (*React, error) {
	_c.defaults()
	return withHooks(ctx, _c.sqlSave, _c.mutation, _c.hooks)
}

// SaveX calls Save and panics if Save returns an error.
func (_c *ReactCreate) SaveX(ctx context.Context) *React {
	v, err := _c.Save(ctx)
	if err != nil {
		panic(err)
	}
...
func (_c *ReactCreate) Exec(ctx context.Context) error {
	_, err := _c.Save(ctx)
	return err
}

// ExecX is like Exec, but panics if an error occurs.
func (_c *ReactCreate) ExecX(ctx context.Context) {
...
func (_c *ReactCreate) check() error {
	if _, ok := _c.mutation.CreatedAt(); !ok {
...
func (_c *ReactCreate) sqlSave(ctx context.Context) (*React, error) {
...
func (_c *ReactCreate) createSpec() (*React, *sqlgraph.CreateSpec) {
	var (
		_node = &React{config: _c.config}
...
//		}).
//		Exec(ctx)
func (_c *ReactCreate) OnConflict(opts ...sql.ConflictOption) *ReactUpsertOne {
	_c.conflict = opts
...
//		Exec(ctx)
func (_c *ReactCreate) OnConflictColumns(columns ...string) *ReactUpsertOne {
...
func (_c *ReactCreateBulk) Save(ctx context.Context) ([]*React, error) {
	if _c.err != nil {
		return nil, _c.err
	}
	specs := make([]*sqlgraph.CreateSpec, len(_c.builders))
	nodes := make([]*React, len(_c.builders))
...
func (_c *ReactCreateBulk) SaveX(ctx context.Context) []*React {
	v, err := _c.Save(ctx)
	if err != nil {
		panic(err)
	}
...
// Exec executes the query.
func (_c *ReactCreateBulk) Exec(ctx context.Context) error {
	_, err := _c.Save(ctx)
	return err
}

// ExecX is like Exec, but panics if an error occurs.
func (_c *ReactCreateBulk) ExecX(ctx context.Context) {
	if err := _c.Exec(ctx); err != nil {
		panic(err)
	}
}
...
//		}).
//		Exec(ctx)
func (_c *ReactCreateBulk) OnConflict(opts ...sql.ConflictOption) *ReactUpsertBulk {
	_c.conflict = opts
...
//		OnConflict(sql.ConflictColumns(columns...)).
//		Exec(ctx)
func (_c *ReactCreateBulk) OnConflictColumns(columns ...string) *ReactUpsertBulk {
	_c.conflict = append(_c.conflict, sql.ConflictColumns(columns...))
	return &ReactUpsertBulk{
		create: _c,
	}
