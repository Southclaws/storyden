...
func (_q *PropertySchemaQuery) Where(ps ...predicate.PropertySchema) *PropertySchemaQuery {
	_q.predicates = append(_q.predicates, ps...)
	return _q
}

// Limit the number of records to be returned by this query.
func (_q *PropertySchemaQuery) Limit(limit int) *PropertySchemaQuery {
	_q.ctx.Limit = &limit
	return _q
}

// Offset to start from.
func (_q *PropertySchemaQuery) Offset(offset int) *PropertySchemaQuery {
...
func (_q *PropertySchemaQuery) Unique(unique bool) *PropertySchemaQuery {
	_q.ctx.Unique = &unique
	return _q
}

// Order specifies how the records should be ordered.
func (_q *PropertySchemaQuery) Order(o ...propertyschema.OrderOption) *PropertySchemaQuery {
	_q.order = append(_q.order, o...)
	return _q
}

// QueryNode chains the current query on the "node" edge.
func (_q *PropertySchemaQuery) QueryNode() *NodeQuery {
...
func (_q *PropertySchemaQuery) QueryFields() *PropertySchemaFieldQuery {
...
func (_q *PropertySchemaQuery) First(ctx context.Context) (*PropertySchema, error) {
...
func (_q *PropertySchemaQuery) FirstX(ctx context.Context) *PropertySchema {
...
func (_q *PropertySchemaQuery) FirstID(ctx context.Context) (id xid.ID, err error) {
	var ids []xid.ID
...
func (_q *PropertySchemaQuery) FirstIDX(ctx context.Context) xid.ID {
...
func (_q *PropertySchemaQuery) Only(ctx context.Context) (*PropertySchema, error) {
...
func (_q *PropertySchemaQuery) OnlyX(ctx context.Context) *PropertySchema {
...
func (_q *PropertySchemaQuery) OnlyID(ctx context.Context) (id xid.ID, err error) {
	var ids []xid.ID
...
func (_q *PropertySchemaQuery) OnlyIDX(ctx context.Context) xid.ID {
...
func (_q *PropertySchemaQuery) All(ctx context.Context) ([]*PropertySchema, error) {
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryAll)
	if err := _q.prepareQuery(ctx); err != nil {
		return nil, err
	}
	qr := querierAll[[]*PropertySchema, *PropertySchemaQuery]()
	return withInterceptors[[]*PropertySchema](ctx, _q, qr, _q.inters)
}

// AllX is like All, but panics if an error occurs.
func (_q *PropertySchemaQuery) AllX(ctx context.Context) []*PropertySchema {
...
func (_q *PropertySchemaQuery) IDs(ctx context.Context) (ids []xid.ID, err error) {
	if _q.ctx.Unique == nil && _q.path != nil {
		_q.Unique(true)
	}
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryIDs)
	if err = _q.Select(propertyschema.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *PropertySchemaQuery) IDsX(ctx context.Context) []xid.ID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PropertySchemaQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryCount)
	if err := _q.prepareQuery(ctx); err != nil {
		return 0, err
	}
	return withInterceptors[int](ctx, _q, querierCount[*PropertySchemaQuery](), _q.inters)
}

// CountX is like Count, but panics if an error occurs.
func (_q *PropertySchemaQuery) CountX(ctx context.Context) int {
...
func (_q *PropertySchemaQuery) Exist(ctx context.Context) (bool, error) {
...
func (_q *PropertySchemaQuery) ExistX(ctx context.Context) bool {
...
func (_q *PropertySchemaQuery) Clone() *PropertySchemaQuery {
	if _q == nil {
		return nil
	}
	return &PropertySchemaQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]propertyschema.OrderOption{}, _q.order...),
		inters:     append([]Interceptor{}, _q.inters...),
		predicates: append([]predicate.PropertySchema{}, _q.predicates...),
...
func (_q *PropertySchemaQuery) WithNode(opts ...func(*NodeQuery)) *PropertySchemaQuery {
	query := (&NodeClient{config: _q.config}).Query()
...
func (_q *PropertySchemaQuery) WithFields(opts ...func(*PropertySchemaFieldQuery)) *PropertySchemaQuery {
	query := (&PropertySchemaFieldClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *PropertySchemaQuery) GroupBy(field string, fields ...string) *PropertySchemaGroupBy {
	_q.ctx.Fields = append([]string{field}, fields...)
	grbuild := &PropertySchemaGroupBy{build: _q}
...
func (_q *PropertySchemaQuery) Select(fields ...string) *PropertySchemaSelect {
	_q.ctx.Fields = append(_q.ctx.Fields, fields...)
	sbuild := &PropertySchemaSelect{PropertySchemaQuery: _q}
...
func (_q *PropertySchemaQuery) Aggregate(fns ...AggregateFunc) *PropertySchemaSelect {
	return _q.Select().Aggregate(fns...)
}

func (_q *PropertySchemaQuery) prepareQuery(ctx context.Context) error {
...
func (_q *PropertySchemaQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*PropertySchema, error) {
	var (
	...
	_spec.Assign = func(columns []string, values []any) error {
		node := &PropertySchema{config: _q.config}
	...
	if query := _q.withNode; query != nil {
		if err := _q.loadNode(ctx, query, nodes,
...
func (_q *PropertySchemaQuery) loadNode(ctx context.Context, query *NodeQuery, nodes []*PropertySchema, init func(*PropertySchema), assign func(*PropertySchema, *Node)) error {
...
func (_q *PropertySchemaQuery) loadFields(ctx context.Context, query *PropertySchemaFieldQuery, nodes []*PropertySchema, init func(*PropertySchema), assign func(*PropertySchema, *PropertySchemaField)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[xid.ID]*PropertySchema)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
...
func (_q *PropertySchemaQuery) sqlCount(ctx context.Context) (int, error) {
	_spec := _q.querySpec()
	if len(_q.modifiers) > 0 {
		_spec.Modifiers = _q.modifiers
	}
...
func (_q *PropertySchemaQuery) querySpec() *sqlgraph.QuerySpec {
...
func (_q *PropertySchemaQuery) sqlQuery(ctx context.Context) *sql.Selector {
...
func (_q *PropertySchemaQuery) Modify(modifiers ...func(s *sql.Selector)) *PropertySchemaSelect {
...
func (_g *PropertySchemaGroupBy) Aggregate(fns ...AggregateFunc) *PropertySchemaGroupBy {
	_g.fns = append(_g.fns, fns...)
	return _g
}

// Scan applies the selector query and scans the result into the given value.
func (_g *PropertySchemaGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, _g.build.ctx, ent.OpQueryGroupBy)
	if err := _g.build.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*PropertySchemaQuery, *PropertySchemaGroupBy](ctx, _g.build, _g, _g.build.inters, v)
}

func (_g *PropertySchemaGroupBy) sqlScan(ctx context.Context, root *PropertySchemaQuery, v any) error {
...
func (_s *PropertySchemaSelect) Aggregate(fns ...AggregateFunc) *PropertySchemaSelect {
	_s.fns = append(_s.fns, fns...)
	return _s
}

// Scan applies the selector query and scans the result into the given value.
func (_s *PropertySchemaSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, _s.ctx, ent.OpQuerySelect)
	if err := _s.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*PropertySchemaQuery, *PropertySchemaSelect](ctx, _s.PropertySchemaQuery, _s, _s.inters, v)
}

func (_s *PropertySchemaSelect) sqlScan(ctx context.Context, root *PropertySchemaQuery, v any) error {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *PropertySchemaSelect) Modify(modifiers ...func(s *sql.Selector)) *PropertySchemaSelect {
