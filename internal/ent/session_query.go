...
func (_q *SessionQuery) FirstID(ctx context.Context) (id xid.ID, err error) {
	var ids []xid.ID
...
func (_q *SessionQuery) FirstIDX(ctx context.Context) xid.ID {
...
func (_q *SessionQuery) OnlyID(ctx context.Context) (id xid.ID, err error) {
	var ids []xid.ID
...
func (_q *SessionQuery) OnlyIDX(ctx context.Context) xid.ID {
...
func (_q *SessionQuery) IDs(ctx context.Context) (ids []xid.ID, err error) {
...
func (_q *SessionQuery) IDsX(ctx context.Context) []xid.ID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
