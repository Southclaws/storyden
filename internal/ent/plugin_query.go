...
func (_q *PluginQuery) QueryAccount() *AccountQuery {
...
func (_q *PluginQuery) FirstID(ctx context.Context) (id xid.ID, err error) {
	var ids []xid.ID
...
func (_q *PluginQuery) FirstIDX(ctx context.Context) xid.ID {
...
func (_q *PluginQuery) OnlyID(ctx context.Context) (id xid.ID, err error) {
	var ids []xid.ID
...
func (_q *PluginQuery) OnlyIDX(ctx context.Context) xid.ID {
...
func (_q *PluginQuery) IDs(ctx context.Context) (ids []xid.ID, err error) {
...
func (_q *PluginQuery) IDsX(ctx context.Context) []xid.ID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PluginQuery) WithAccount(opts ...func(*AccountQuery)) *PluginQuery {
	query := (&AccountClient{config: _q.config}).Query()
...
func (_q *PluginQuery) loadAccount(ctx context.Context, query *AccountQuery, nodes []*Plugin, init func(*Plugin), assign func(*Plugin, *Account)) error {
...
func (_q *PluginQuery) Modify(modifiers ...func(s *sql.Selector)) *PluginSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *PluginSelect) Modify(modifiers ...func(s *sql.Selector)) *PluginSelect {
