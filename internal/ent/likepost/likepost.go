...
const (
	// Label holds the string label denoting the likepost type in the database.
	Label = "like_post"
	...
	EdgePost = "Post"
	// Table holds the table name of the likepost in the database.
	Table = "like_posts"
	// AccountTable is the table that holds the account relation/edge.
	AccountTable = "like_posts"
...
// Columns holds all SQL columns for likepost fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldAccountID,
...
// OrderOption defines the ordering options for the LikePost queries.
