...
// The RobotSessionInputFunc type is an adapter to allow the use of ordinary
// function as RobotSessionInput mutator.
type RobotSessionInputFunc func(context.Context, *ent.RobotSessionInputMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f RobotSessionInputFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.RobotSessionInputMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.RobotSessionInputMutation", m)
}
...
// The RobotSessionTurnFunc type is an adapter to allow the use of ordinary
// function as RobotSessionTurn mutator.
type RobotSessionTurnFunc func(context.Context, *ent.RobotSessionTurnMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f RobotSessionTurnFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.RobotSessionTurnMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.RobotSessionTurnMutation", m)
}
...
// Mutate calls f(ctx, m).
func (f RobotToolsetFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.RobotToolsetMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.RobotToolsetMutation", m)
}
...
// Mutate calls f(ctx, m).
func (f WarningFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.WarningMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.WarningMutation", m)
}
