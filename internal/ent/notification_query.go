...
func (_q *NotificationQuery) QueryOwner() *AccountQuery {
...
func (_q *NotificationQuery) QuerySource() *AccountQuery {
	query := (&AccountClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *NotificationQuery) FirstID(ctx context.Context) (id xid.ID, err error) {
	var ids []xid.ID
...
func (_q *NotificationQuery) FirstIDX(ctx context.Context) xid.ID {
...
func (_q *NotificationQuery) OnlyID(ctx context.Context) (id xid.ID, err error) {
	var ids []xid.ID
...
func (_q *NotificationQuery) OnlyIDX(ctx context.Context) xid.ID {
...
func (_q *NotificationQuery) IDs(ctx context.Context) (ids []xid.ID, err error) {
...
func (_q *NotificationQuery) IDsX(ctx context.Context) []xid.ID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *NotificationQuery) WithOwner(opts ...func(*AccountQuery)) *NotificationQuery {
	query := (&AccountClient{config: _q.config}).Query()
...
func (_q *NotificationQuery) WithSource(opts ...func(*AccountQuery)) *NotificationQuery {
	query := (&AccountClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *NotificationQuery) loadOwner(ctx context.Context, query *AccountQuery, nodes []*Notification, init func(*Notification), assign func(*Notification, *Account)) error {
...
func (_q *NotificationQuery) loadSource(ctx context.Context, query *AccountQuery, nodes []*Notification, init func(*Notification), assign func(*Notification, *Account)) error {
	ids := make([]xid.ID, 0, len(nodes))
	nodeids := make(map[xid.ID][]*Notification)
	for i := range nodes {
