...
func (_q *RoleQuery) QueryAccountRoles() *AccountRolesQuery {
...
func (_q *RoleQuery) FirstID(ctx context.Context) (id xid.ID, err error) {
	var ids []xid.ID
...
func (_q *RoleQuery) FirstIDX(ctx context.Context) xid.ID {
...
func (_q *RoleQuery) OnlyID(ctx context.Context) (id xid.ID, err error) {
	var ids []xid.ID
...
func (_q *RoleQuery) OnlyIDX(ctx context.Context) xid.ID {
...
func (_q *RoleQuery) IDs(ctx context.Context) (ids []xid.ID, err error) {
...
func (_q *RoleQuery) IDsX(ctx context.Context) []xid.ID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *RoleQuery) WithAccountRoles(opts ...func(*AccountRolesQuery)) *RoleQuery {
	query := (&AccountRolesClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *RoleQuery) loadAccounts(ctx context.Context, query *AccountQuery, nodes []*Role, init func(*Role), assign func(*Role, *Account)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(role.AccountsTable)
		s.Join(joinT).On(s.C(account.FieldID), joinT.C(role.AccountsPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(role.AccountsPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(role.AccountsPrimaryKey[0]))
...
func (_q *RoleQuery) loadAccountRoles(ctx context.Context, query *AccountRolesQuery, nodes []*Role, init func(*Role), assign func(*Role, *AccountRoles)) error {
