...
func (iq *InvitationQuery) QueryCreator() *AccountQuery {
...
func (iq *InvitationQuery) QueryInvited() *AccountQuery {
	query := (&AccountClient{config: iq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := iq.prepareQuery(ctx); err != nil {
			return nil, err
...
func (iq *InvitationQuery) FirstID(ctx context.Context) (id xid.ID, err error) {
	var ids []xid.ID
...
func (iq *InvitationQuery) FirstIDX(ctx context.Context) xid.ID {
...
func (iq *InvitationQuery) OnlyID(ctx context.Context) (id xid.ID, err error) {
	var ids []xid.ID
...
func (iq *InvitationQuery) OnlyIDX(ctx context.Context) xid.ID {
...
func (iq *InvitationQuery) IDs(ctx context.Context) (ids []xid.ID, err error) {
...
func (iq *InvitationQuery) IDsX(ctx context.Context) []xid.ID {
	ids, err := iq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (iq *InvitationQuery) Clone() *InvitationQuery {
	...
	return &InvitationQuery{
		...
		withInvited: iq.withInvited.Clone(),
...
func (iq *InvitationQuery) WithCreator(opts ...func(*AccountQuery)) *InvitationQuery {
	query := (&AccountClient{config: iq.config}).Query()
...
func (iq *InvitationQuery) WithInvited(opts ...func(*AccountQuery)) *InvitationQuery {
	query := (&AccountClient{config: iq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	iq.withInvited = query
	return iq
}
...
func (iq *InvitationQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Invitation, error) {
	...
	if query := iq.withInvited; query != nil {
		if err := iq.loadInvited(ctx, query, nodes,
...
func (iq *InvitationQuery) loadCreator(ctx context.Context, query *AccountQuery, nodes []*Invitation, init func(*Invitation), assign func(*Invitation, *Account)) error {
...
func (iq *InvitationQuery) loadInvited(ctx context.Context, query *AccountQuery, nodes []*Invitation, init func(*Invitation), assign func(*Invitation, *Account)) error {
...
func (iq *InvitationQuery) Modify(modifiers ...func(s *sql.Selector)) *InvitationSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (is *InvitationSelect) Modify(modifiers ...func(s *sql.Selector)) *InvitationSelect {
