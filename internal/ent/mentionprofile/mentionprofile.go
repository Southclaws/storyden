...
const (
	// Label holds the string label denoting the mentionprofile type in the database.
	Label = "mention_profile"
	...
	EdgePost = "Post"
	// Table holds the table name of the mentionprofile in the database.
	Table = "mention_profiles"
	// AccountTable is the table that holds the account relation/edge.
	AccountTable = "mention_profiles"
...
// Columns holds all SQL columns for mentionprofile fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldAccountID,
...
// OrderOption defines the ordering options for the MentionProfile queries.
