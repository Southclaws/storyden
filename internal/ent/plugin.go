	...
	for i := range columns {
		...
		case entplugin.FieldManifest:
			if value, ok := values[i].(*[]byte); !ok {
				...
				if err := json.Unmarshal(*value, &pl.Manifest); err != nil {
...
func (pl *Plugin) QueryAccount() *AccountQuery {
	return NewPluginClient(pl.config).QueryAccount(pl)
}
...
func (pl *Plugin) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", pl.Manifest))
	builder.WriteString(", ")
	builder.WriteString("config=")
	builder.WriteString(fmt.Sprintf("%v", pl.Config))
	builder.WriteString(", ")
	builder.WriteString("active_state=")
	builder.WriteString(pl.ActiveState)
	builder.WriteString(", ")
	builder.WriteString("active_state_changed_at=")
	builder.WriteString(pl.ActiveStateChangedAt.Format(time.ANSIC))
	builder.WriteString(", ")
	if v := pl.StatusMessage; v != nil {
		builder.WriteString("status_message=")
		builder.WriteString(*v)
	}
	builder.WriteString(", ")
	builder.WriteString("status_details=")
	builder.WriteString(fmt.Sprintf("%v", pl.StatusDetails))
	builder.WriteString(", ")
	builder.WriteString("added_by=")
	builder.WriteString(fmt.Sprintf("%v", pl.AddedBy))
	builder.WriteByte(')')
