...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		...
		c.Notification, c.Plugin, c.Post, c.Property, c.PropertySchema,
...
func (c *AccountClient) QuerySessions(a *Account) *SessionQuery {
...
func (c *AccountClient) QueryPlugins(a *Account) *PluginQuery {
...
func (c *PluginClient) QueryAccount(pl *Plugin) *AccountQuery {
	query := (&AccountClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := pl.ID
		step := sqlgraph.NewStep(
...
func (c *QuestionClient) QueryParent(q *Question) *QuestionQuery {
	query := (&QuestionClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := q.ID
		step := sqlgraph.NewStep(
...
func (c *QuestionClient) QueryParentQuestion(q *Question) *QuestionQuery {
	query := (&QuestionClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := q.ID
		step := sqlgraph.NewStep(
