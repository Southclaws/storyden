...
func (_q *TagQuery) QueryNodes() *NodeQuery {
...
func (_q *TagQuery) QueryAccounts() *AccountQuery {
...
func (_q *TagQuery) FirstID(ctx context.Context) (id xid.ID, err error) {
	var ids []xid.ID
...
func (_q *TagQuery) FirstIDX(ctx context.Context) xid.ID {
...
func (_q *TagQuery) OnlyID(ctx context.Context) (id xid.ID, err error) {
	var ids []xid.ID
...
func (_q *TagQuery) OnlyIDX(ctx context.Context) xid.ID {
...
func (_q *TagQuery) IDs(ctx context.Context) (ids []xid.ID, err error) {
...
func (_q *TagQuery) IDsX(ctx context.Context) []xid.ID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *TagQuery) WithNodes(opts ...func(*NodeQuery)) *TagQuery {
	query := (&NodeClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *TagQuery) WithAccounts(opts ...func(*AccountQuery)) *TagQuery {
	query := (&AccountClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *TagQuery) loadNodes(ctx context.Context, query *NodeQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *Node)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[xid.ID]*Tag)
	nids := make(map[xid.ID]map[*Tag]struct{})
	for i, node := range nodes {
...
func (_q *TagQuery) loadAccounts(ctx context.Context, query *AccountQuery, nodes []*Tag, init func(*Tag), assign func(*Tag, *Account)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[xid.ID]*Tag)
	nids := make(map[xid.ID]map[*Tag]struct{})
	for i, node := range nodes {
