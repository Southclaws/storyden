...
type Account struct {
	...
	// VerifiedStatus holds the value of the "verified_status" field.
	VerifiedStatus account.VerifiedStatus `json:"verified_status,omitempty"`
...
type AccountEdges struct {
	...
	// NodeVersions holds the value of the node_versions edge.
	NodeVersions []*NodeVersion `json:"node_versions,omitempty"`
	...
	// RobotSessionInputs holds the value of the robot_session_inputs edge.
...
func (*Account) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case account.FieldHandle, account.FieldName, account.FieldBio, account.FieldSignature, account.FieldKind, account.FieldVerifiedStatus:
...
func (_m *Account) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case account.FieldVerifiedStatus:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field verified_status", values[i])
			} else if value.Valid {
				_m.VerifiedStatus = account.VerifiedStatus(value.String)
			}
		case account.FieldAdmin:
...
// QueryNodeVersions queries the "node_versions" edge of the Account entity.
func (_m *Account) QueryNodeVersions() *NodeVersionQuery {
	return NewAccountClient(_m.config).QueryNodeVersions(_m)
}
...
// QueryRobotSessionInputs queries the "robot_session_inputs" edge of the Account entity.
func (_m *Account) QueryRobotSessionInputs() *RobotSessionInputQuery {
	return NewAccountClient(_m.config).QueryRobotSessionInputs(_m)
}
...
func (_m *Account) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("verified_status=")
	builder.WriteString(fmt.Sprintf("%v", _m.VerifiedStatus))
	builder.WriteString(", ")
