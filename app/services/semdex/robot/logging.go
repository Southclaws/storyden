...
func logBeforeTool(logger *slog.Logger) llmagent.BeforeToolCallback {
	return func(ctx adkagent.Context, tl adktool.Tool, args map[string]any) (map[string]any, error) {
		logger.Info(
			"agent tool start",
...
func logAfterTool(logger *slog.Logger) llmagent.AfterToolCallback {
	return func(ctx adkagent.Context, tl adktool.Tool, args map[string]any, result map[string]any, err error) (map[string]any, error) {
