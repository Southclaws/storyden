...
func newLibraryTools(
	...
	registry.RegisterAlias("library_search", mcp.GetLibrarySearchPagesTool().Name)

	return t
}

func (lt *libraryTools) newLibraryRequestPageTool() *Tool {
	toolDef := mcp.GetLibraryRequestPageTool()
...
func (lt *libraryTools) newLibraryPageTreeTool() *Tool {
	...
	return &Tool{
		...
		Handler: makeHandler(lt.ExecuteLibraryPageTree),
	}
}

func (lt *libraryTools) ExecuteLibraryPageTree(ctx context.Context, args mcp.ToolLibraryPageTreeInput) (*mcp.ToolLibraryPageTreeOutput, error) {
...
func (lt *libraryTools) mapNodeToTreeNode(n *library.Node) mcp.LibraryPageTreeNode {
	node := mcp.LibraryPageTreeNode{
		BrowserUrl:  datagraph.CanonicalResolveMarkURL(lt.webAddress, datagraph.KindNode, n.Mark.Mark).String(),
		Id:          n.GetID().String(),
		Slug:        n.Mark.Slug(),
		Name:        n.Name,
...
func (lt *libraryTools) newLibraryPageGetTool() *Tool {
	...
	return &Tool{
		...
		Handler: makeHandler(lt.ExecuteLibraryPageGet),
	}
}

func (lt *libraryTools) ExecuteLibraryPageGet(ctx context.Context, args mcp.ToolLibraryPageGetInput) (*mcp.ToolLibraryPageGetOutput, error) {
...
func (lt *libraryTools) newLibraryPageCreateTool() *Tool {
	...
	return &Tool{
		...
		Handler: makeHandler(lt.ExecuteLibraryPageCreate),
	}
}

func (lt *libraryTools) ExecuteLibraryPageCreate(ctx context.Context, args mcp.ToolLibraryPageCreateInput) (*mcp.ToolLibraryPageCreateOutput, error) {
...
func (lt *libraryTools) newLibraryPageUpdateTool() *Tool {
	...
	return &Tool{
		...
		Handler: makeHandler(lt.ExecuteLibraryPageUpdate),
	}
}

func (lt *libraryTools) ExecuteLibraryPageUpdate(ctx context.Context, args mcp.ToolLibraryPageUpdateInput) (*mcp.ToolLibraryPageUpdateOutput, error) {
...
func (lt *libraryTools) newLibrarySearchPagesTool() *Tool {
	toolDef := mcp.GetLibrarySearchPagesTool()
	...
	return &Tool{
		...
		Handler: makeHandler(lt.ExecuteLibrarySearchPages),
	}
}

func (lt *libraryTools) ExecuteLibrarySearchPages(ctx context.Context, args mcp.ToolLibrarySearchPagesInput) (*mcp.ToolLibrarySearchPagesOutput, error) {
	...
	items := dt.Map(result.Items, func(item datagraph.Item) mcp.LibraryPageSearchItem {
		...
		return mcp.LibraryPageSearchItem{
			BrowserUrl:  datagraph.CanonicalResolveURL(lt.webAddress, datagraph.KindNode, fmt.Sprintf("%s-%s", item.GetID().String(), item.GetSlug())).String(),
	...
	output := mcp.ToolLibrarySearchPagesOutput{
...
func (lt *libraryTools) newLibraryPagePropertySchemaGetTool() *Tool {
	...
	return &Tool{
		...
		Handler: makeHandler(lt.ExecuteLibraryPagePropertySchemaGet),
	}
}

func (lt *libraryTools) ExecuteLibraryPagePropertySchemaGet(ctx context.Context, args mcp.ToolLibraryPagePropertySchemaGetInput) (*mcp.ToolLibraryPagePropertySchemaGetOutput, error) {
	node, err := lt.nodeReader.GetBySlug(ctx, library.NewKey(args.Id), nil)
	if err != nil {
		return nil, err
	}
...
func (lt *libraryTools) newLibraryPagePropertySchemaUpdateTool() *Tool {
	...
	return &Tool{
		...
		Handler: makeHandler(lt.ExecuteLibraryPagePropertySchemaUpdate),
	}
}

func (lt *libraryTools) ExecuteLibraryPagePropertySchemaUpdate(ctx context.Context, args mcp.ToolLibraryPagePropertySchemaUpdateInput) (*mcp.ToolLibraryPagePropertySchemaUpdateOutput, error) {
...
func (lt *libraryTools) newLibraryPagePropertiesUpdateTool() *Tool {
	...
	return &Tool{
		...
		Handler: makeHandler(lt.ExecuteLibraryPagePropertiesUpdate),
	}
}

func (lt *libraryTools) ExecuteLibraryPagePropertiesUpdate(ctx context.Context, args mcp.ToolLibraryPagePropertiesUpdateInput) (*mcp.ToolLibraryPagePropertiesUpdateOutput, error) {
