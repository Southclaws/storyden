	...
	return &Tool{
		...
		Builder: func(ctx context.Context) (tool.Tool, error) {
			return functiontool.New(
				...
				func(ctx adkagent.Context, args mcp.ToolThreadCreateInput) (*mcp.ToolThreadCreateOutput, error) {
					return tt.ExecuteThreadCreate(ctx, args)
				},
			)
		},
		Handler: makeHandler(tt.ExecuteThreadCreate),
	}
}

func (tt *threadTools) ExecuteThreadCreate(ctx context.Context, args mcp.ToolThreadCreateInput) (*mcp.ToolThreadCreateOutput, error) {
	...
	output := mcp.ToolThreadCreateOutput{
		BrowserUrl: datagraph.CanonicalResolveURL(tt.webAddress, datagraph.KindThread, fmt.Sprintf("%s-%s", createdThread.ID.String(), createdThread.Slug)).String(),
	...
	return &Tool{
		...
		Builder: func(ctx context.Context) (tool.Tool, error) {
			return functiontool.New(
				...
				func(ctx adkagent.Context, args mcp.ToolThreadListInput) (*mcp.ToolThreadListOutput, error) {
					return tt.ExecuteThreadList(ctx, args)
				},
			)
		},
		Handler: makeHandler(tt.ExecuteThreadList),
	}
}

func (tt *threadTools) ExecuteThreadList(ctx context.Context, args mcp.ToolThreadListInput) (*mcp.ToolThreadListOutput, error) {
	page := 1
	if args.Page != nil {
		page = *args.Page
	}
	...
	output := mcp.ToolThreadListOutput{
		Threads:      dt.Map(result.Threads, tt.mapThreadSummary),
		CurrentPage:  page,
	...
	return &Tool{
		...
		Builder: func(ctx context.Context) (tool.Tool, error) {
			return functiontool.New(
				...
				func(ctx adkagent.Context, args mcp.ToolThreadGetInput) (*mcp.ToolThreadGetOutput, error) {
					return tt.ExecuteThreadGet(ctx, args)
				},
			)
		},
		Handler: makeHandler(tt.ExecuteThreadGet),
	}
}

func (tt *threadTools) ExecuteThreadGet(ctx context.Context, args mcp.ToolThreadGetInput) (*mcp.ToolThreadGetOutput, error) {
...
func (tt *threadTools) mapThreadSummary(t *thread.Thread) mcp.ThreadSummary {
	return mcp.ThreadSummary{
		BrowserUrl: datagraph.CanonicalResolveURL(tt.webAddress, datagraph.KindThread, fmt.Sprintf("%s-%s", t.ID.String(), t.Slug)).String(),
		Id:         t.ID.String(),
		Slug:       t.Slug,
		Title:      t.Title,
		Excerpt:    t.Short,
	...
	return &Tool{
		...
		Builder: func(ctx context.Context) (tool.Tool, error) {
			return functiontool.New(
				...
				func(ctx adkagent.Context, args mcp.ToolThreadUpdateInput) (*mcp.ToolThreadUpdateOutput, error) {
					return tt.ExecuteThreadUpdate(ctx, args)
				},
			)
		},
		Handler: makeHandler(tt.ExecuteThreadUpdate),
	}
}

func (tt *threadTools) ExecuteThreadUpdate(ctx context.Context, args mcp.ToolThreadUpdateInput) (*mcp.ToolThreadUpdateOutput, error) {
	postID, err := tt.thread_mark_svc.Lookup(ctx, args.Id)
	if err != nil {
		return nil, fault.Wrap(err, fctx.With(ctx))
	}
	...
	return &Tool{
		...
		Builder: func(ctx context.Context) (tool.Tool, error) {
			return functiontool.New(
				...
				func(ctx adkagent.Context, args mcp.ToolThreadReplyInput) (*mcp.ToolThreadReplyOutput, error) {
					return tt.ExecuteThreadReply(ctx, args)
				},
			)
		},
		Handler: makeHandler(tt.ExecuteThreadReply),
	}
}

func (tt *threadTools) ExecuteThreadReply(ctx context.Context, args mcp.ToolThreadReplyInput) (*mcp.ToolThreadReplyOutput, error) {
	accountID, err := session.GetAccountID(ctx)
	if err != nil {
		return nil, fault.Wrap(err, fctx.With(ctx))
	}
	...
	output := mcp.ToolThreadReplyOutput{
		BrowserUrl: datagraph.CanonicalResolveURL(tt.webAddress, datagraph.KindReply, reply.ID.String()).String(),
		Id:         reply.ID.String(),
	...
	return &Tool{
		...
		Builder: func(ctx context.Context) (tool.Tool, error) {
			return functiontool.New(
				...
				func(ctx adkagent.Context, args map[string]any) (*mcp.ToolCategoryListOutput, error) {
					return tt.ExecuteCategoryList(ctx, args)
				},
			)
		},
		Handler: makeHandler(tt.ExecuteCategoryList),
	}
}

func (tt *threadTools) ExecuteCategoryList(ctx context.Context, args map[string]any) (*mcp.ToolCategoryListOutput, error) {
