...
type ComplexityRoot struct {
	Mutation struct {
		CreateThread func(childComplexity int, input models.NewThread) int
	}
...
type MutationResolver interface {
	CreateThread(ctx context.Context, input models.NewThread) (*models.Thread, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.createThread":
		...
		return e.complexity.Mutation.CreateThread(childComplexity, args["input"].(models.NewThread)), true
...
var sources = []*ast.Source{
	{Name: "../../../../api/thread.graphqls", Input: `type Thread {
  id: ID!
}
...
func (ec *executionContext) field_Mutation_createThread_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	var arg0 models.NewThread
	if tmp, ok := rawArgs["input"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("input"))
		arg0, err = ec.unmarshalNNewThread2githubᚗcomᚋSouthclawsᚋstorydenᚋappᚋtransportsᚋgraphqlᚋmodelsᚐNewThread(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createThread(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().CreateThread(rctx, fc.Args["input"].(models.NewThread))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalNThread2ᚖgithubᚗcomᚋSouthclawsᚋstorydenᚋappᚋtransportsᚋgraphqlᚋmodelsᚐThread(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputNewThread(ctx context.Context, obj interface{}) (models.NewThread, error) {
	var it models.NewThread
	asMap := map[string]interface{}{}
	for k, v := range obj.(map[string]interface{}) {
		asMap[k] = v
	}

	fieldsInOrder := [...]string{"title", "body", "tags", "category"}
...
func (ec *executionContext) unmarshalNNewThread2githubᚗcomᚋSouthclawsᚋstorydenᚋappᚋtransportsᚋgraphqlᚋmodelsᚐNewThread(ctx context.Context, v interface{}) (models.NewThread, error) {
...
func (ec *executionContext) marshalNThread2githubᚗcomᚋSouthclawsᚋstorydenᚋappᚋtransportsᚋgraphqlᚋmodelsᚐThread(ctx context.Context, sel ast.SelectionSet, v models.Thread) graphql.Marshaler {
	return ec._Thread(ctx, sel, &v)
}

func (ec *executionContext) marshalNThread2ᚖgithubᚗcomᚋSouthclawsᚋstorydenᚋappᚋtransportsᚋgraphqlᚋmodelsᚐThread(ctx context.Context, sel ast.SelectionSet, v *models.Thread) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
