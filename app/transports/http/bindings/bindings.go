...
func addMiddleware(cfg config.Config, l *zap.Logger, router *echo.Echo, cj *cookie.Jar, auth Authentication) error {
	...
	router.Use(openapi.ParameterContext)
	router.Use(echo.WrapMiddleware(useragent.UserAgentContext))
