...
var (
	...
	PermissionManageTrails             = Permission{`MANAGE_TRAILS`}
...
func NewPermission(__iNpUt__ string) (Permission, error) {
	...
	case string(`USE_OAUTH_CLIENTS`):
		return PermissionUseOauthClients, nil
	case string(`MANAGE_SETTINGS`):
		return PermissionManageSettings, nil
	case string(`MANAGE_ACCOUNTS`):
		return PermissionManageAccounts, nil
	...
	case string(`VIEW_MODERATION_NOTES`):
		return PermissionViewModerationNotes, nil
	case string(`MANAGE_MODERATION_NOTES`):
		return PermissionManageModerationNotes, nil
	case string(`USE_ROBOTS`):
		return PermissionUseRobots, nil
	case string(`MANAGE_ROBOTS`):
		return PermissionManageRobots, nil
	case string(`MANAGE_TRAILS`):
		return PermissionManageTrails, nil
