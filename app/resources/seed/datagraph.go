...
var Cluster_Ancient = datagraph.Cluster{
	...
	ImageURL:    opt.New("https://ih1.redbubble.net/image.499157992.1766/flat,1000x1000,075,f.u1.jpg"),
	Items: []*datagraph.Item{
		{
			ID:          datagraph.ItemID(id("00000000000010000010")),
			Owner:       profile.Profile{ID: Account_001_Odin.ID},
			Name:        "Hringhorni",
			ImageURL:    opt.New("https://upload.wikimedia.org/wikipedia/commons/1/18/Thor_kicks_Litr.jpg"),
...
`),
		...
		},
		{
			...
			Owner:       profile.Profile{ID: Account_001_Odin.ID},
			Name:        "Skíðblaðnir",
			ImageURL:    opt.New("https://upload.wikimedia.org/wikipedia/commons/4/4c/The_third_gift_%E2%80%94_an_enormous_hammer_by_Elmer_Boyd_Smith.jpg"),
...
var Cluster_Steam = datagraph.Cluster{
	...
	Owner:       profile.Profile{ID: Account_001_Odin.ID},
	Name:        "Steam ships",
	ImageURL:    opt.New("https://media.cnn.com/api/v1/images/stellar/prod/140730133850-belle-of-louisville.jpg?q=w_1884,h_1024,x_0,y_0,c_fill"),
	...
	Items: []*datagraph.Item{
		{
			...
			ImageURL:    opt.New("https://lh3.googleusercontent.com/p/AF1QipOTf1f7dzR1NXixsT9caL8gdSrztqMDNM3uCkIB=s1360-w1360-h1020"),
		...
		},
		{
			...
			Owner:       profile.Profile{ID: Account_001_Odin.ID},
			Name:        "Katahdin",
			ImageURL:    opt.New("https://upload.wikimedia.org/wikipedia/commons/3/33/SSKatahdinII.jpg"),
		...
		},
		{
			...
			Owner:       profile.Profile{ID: Account_001_Odin.ID},
			Name:        "Minnehaha",
			ImageURL:    opt.New("https://upload.wikimedia.org/wikipedia/commons/thumb/3/3d/Steamboat_Minnehaha%2C_1906.jpg/440px-Steamboat_Minnehaha%2C_1906.jpg"),
...
func clusters_items(cluster_repo cluster.Repository, item_repo item.Repository) {
	...
	for _, c := range Clusters {
		...
		_, err := cluster_repo.Create(ctx,
			...
			c.Description,
			cluster.WithID(c.ID),
			cluster.WithImageURL(c.ImageURL.String()),
		...
		for _, i := range c.Items {
			...
			_, err := item_repo.Create(ctx,
				...
				item.WithImageURL(i.ImageURL.String()),
