...
func (c *Cache) IsNotModified(ctx context.Context, cq cachecontrol.Query, slug string) bool {
...
func (c *Cache) touch(ctx context.Context, slug string) error {
	return c.storeTimestamp(ctx, slug, c.clock().UTC())
}
