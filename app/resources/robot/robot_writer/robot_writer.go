...
func WithModel(v model_ref.ModelRef) Option {
	return func(m *ent.RobotMutation) {
		m.SetModel(v.String())
	}
}

func WithTools(v []robot_ref.ToolName) Option {
	return func(m *ent.RobotMutation) {
...
func WithWorkspaceID(id xid.ID) Option {
	return func(m *ent.RobotMutation) {
		m.SetWorkspaceID(id)
	}
}

func WithoutWorkspaceID() Option {
	return func(m *ent.RobotMutation) {
		m.ClearWorkspaceID()
	}
}
