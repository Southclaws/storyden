...
//go:generate go run -mod=mod github.com/lerenn/asyncapi-codegen/cmd/asyncapi-codegen@latest -i api/asyncapi.yaml -p asyncapi -o app/transports/ws/asyncapi/asyncapi_gen.go
