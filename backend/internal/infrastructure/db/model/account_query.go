...
func (aq *AccountQuery) sqlAll(ctx context.Context) ([]*Account, error) {
	...
	if query := aq.withPosts; query != nil {
		...
		for _, n := range neighbors {
			fk := n.account_posts
			if fk == nil {
				return nil, fmt.Errorf(`foreign-key "account_posts" is nil for node %v`, n.ID)
			}
			node, ok := nodeids[*fk]
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "account_posts" returned %v for node %v`, *fk, n.ID)
			}
	...
	if query := aq.withReacts; query != nil {
		...
		for _, n := range neighbors {
			fk := n.account_reacts
			if fk == nil {
				return nil, fmt.Errorf(`foreign-key "account_reacts" is nil for node %v`, n.ID)
			}
			node, ok := nodeids[*fk]
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "account_reacts" returned %v for node %v`, *fk, n.ID)
			}
	...
	if query := aq.withSubscriptions; query != nil {
		...
		for i := range nodes {
			fks = append(fks, nodes[i].ID)
			nodeids[nodes[i].ID] = nodes[i]
			nodes[i].Edges.Subscriptions = []*Subscription{}
		}
		query.withFKs = true
		...
		for _, n := range neighbors {
			...
			if fk == nil {
				return nil, fmt.Errorf(`foreign-key "account_subscriptions" is nil for node %v`, n.ID)
			}
			node, ok := nodeids[*fk]
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "account_subscriptions" returned %v for node %v`, *fk, n.ID)
			}
	...
	if query := aq.withAuthentication; query != nil {
		...
		for i := range nodes {
			fks = append(fks, nodes[i].ID)
			nodeids[nodes[i].ID] = nodes[i]
			nodes[i].Edges.Authentication = []*Authentication{}
		}
		query.withFKs = true
		...
		for _, n := range neighbors {
			...
			if fk == nil {
				return nil, fmt.Errorf(`foreign-key "account_authentication" is nil for node %v`, n.ID)
			}
			node, ok := nodeids[*fk]
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "account_authentication" returned %v for node %v`, *fk, n.ID)
			}
...
func (agb *AccountGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(agb.fields) > 1 {
		return nil, errors.New("model: AccountGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := agb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (agb *AccountGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{account.Label}
	default:
		err = fmt.Errorf("model: AccountGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (agb *AccountGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(agb.fields) > 1 {
		return nil, errors.New("model: AccountGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := agb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (agb *AccountGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{account.Label}
	default:
		err = fmt.Errorf("model: AccountGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (agb *AccountGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(agb.fields) > 1 {
		return nil, errors.New("model: AccountGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := agb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (agb *AccountGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{account.Label}
	default:
		err = fmt.Errorf("model: AccountGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (agb *AccountGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(agb.fields) > 1 {
		return nil, errors.New("model: AccountGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := agb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (agb *AccountGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{account.Label}
	default:
		err = fmt.Errorf("model: AccountGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (as *AccountSelect) Strings(ctx context.Context) ([]string, error) {
	if len(as.fields) > 1 {
		return nil, errors.New("model: AccountSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := as.Scan(ctx, &v); err != nil {
		return nil, err
...
func (as *AccountSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{account.Label}
	default:
		err = fmt.Errorf("model: AccountSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (as *AccountSelect) Ints(ctx context.Context) ([]int, error) {
	if len(as.fields) > 1 {
		return nil, errors.New("model: AccountSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := as.Scan(ctx, &v); err != nil {
		return nil, err
...
func (as *AccountSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{account.Label}
	default:
		err = fmt.Errorf("model: AccountSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (as *AccountSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(as.fields) > 1 {
		return nil, errors.New("model: AccountSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := as.Scan(ctx, &v); err != nil {
		return nil, err
...
func (as *AccountSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{account.Label}
	default:
		err = fmt.Errorf("model: AccountSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (as *AccountSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(as.fields) > 1 {
		return nil, errors.New("model: AccountSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := as.Scan(ctx, &v); err != nil {
		return nil, err
...
func (as *AccountSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{account.Label}
	default:
		err = fmt.Errorf("model: AccountSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
