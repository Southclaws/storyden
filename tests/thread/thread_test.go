	...
	integration.Test(t, nil, e2e.Setup(), fx.Invoke(func(
		...
		lc.Append(fx.StartHook(func() {
			...
			t.Run("reply_to_reply", func(t *testing.T) {
				...
				a.Equal(reply1create.JSON200.Id, *reply2create.JSON200.ReplyTo, "nested reply should reference first reply")
				...
				a.Equal(reply1create.JSON200.Id, *reply2get.ReplyTo, "nested reply should reference first reply")
			})
