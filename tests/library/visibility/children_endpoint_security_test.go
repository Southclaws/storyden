...
// TestChildrenEndpointVsTreeConsistency ensures that the /children endpoint
// applies the same visibility rules as the tree view endpoints.
// This test exists specifically to address issue #450.
