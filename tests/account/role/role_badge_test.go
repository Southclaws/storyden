	...
	integration.Test(t, nil, e2e.Setup(), fx.Invoke(func(
		...
		lc.Append(fx.StartHook(func() {
			...
			t.Run("role_manager_can_set_other_member_badges", func(t *testing.T) {
				...
				tests.AssertRequest(cl.AccountRoleSetBadgeWithResponse(targetCtx, targetHandle, role1ID, adminSession))(t, http.StatusOK)

				tests.AssertRequest(cl.AccountRoleRemoveBadgeWithResponse(targetCtx, targetHandle, role1ID, adminSession))(t, http.StatusOK)
			})
		}))
	}))
}
